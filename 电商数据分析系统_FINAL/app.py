...
sys.path.insert(0, r"C:\Users\Y'T'L'~1\AppData\Local\Temp\jd_analysis_project")
from data_processor import DataProcessor
from visualizer import Visualizer

app = Flask(__name__)

BASE = r"C:\Users\Y'T'L'~1\AppData\Local\Temp\jd_analysis_project"
...
# Init
processor = DataProcessor(DATA_DIR).load_data()
metrics = processor.compute_metrics()
processor.compute_rfm()
viz = Visualizer(processor, IMG_DIR)
viz.generate_all()
